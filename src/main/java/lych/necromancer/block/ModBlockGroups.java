...
public final class ModBlockGroups {
    public static final StoneBlockGroup NECROCK = newStoneBlockGroupWithPolishedRef(ModBlockNames.NECROCK, using(p -> p.mapColor(MapColor.COLOR_BLACK).requiresCorrectToolForDrops().strength(1.5F, 6).sound(SoundType.STONE)), () -> ModBlockGroups.POLISHED_NECROCK);
